...
program
    ...
    try {
        ...
        const sdk = new sdk_1.LSMSDK(configPath, dbConfig);
        // 执行查询
...
program
    ...
    try {
        ...
        const sdk = new sdk_1.LSMSDK(configPath, dbConfig);
        // 创建标签查询实例
        const labelQuery = new label_1.LabelQuery(sdk.getConfig(), sdk.getDatabase());
        // 查询标签
...
program
    ...
    try {
        ...
        // 初始化Git管理器
        const gitManager = new git_1.GitManager(gitConfig);
        // 初始化仓库
